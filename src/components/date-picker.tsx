...
function CustomCalendar({
    ...
    return (
        <div className="p-4 bg-white rounded-2xl w-[320px]">
            <div className="flex items-center justify-between mb-4 px-1 select-none">
                <Button variant="ghost" size="icon" className="h-7 w-7 rounded-full hover:bg-gray-100" onClick={handlePrevMonth}>
                    <ChevronLeft className="h-4 w-4 text-gray-600" />
                </Button>
                <div className="font-bold text-gray-800 text-sm flex gap-1 items-center">
                    <select
                        className="bg-transparent hover:bg-gray-50 rounded px-1 py-0.5 outline-none cursor-pointer appearance-none text-center"
                ...
                <Button variant="ghost" size="icon" className="h-7 w-7 rounded-full hover:bg-gray-100" onClick={handleNextMonth}>
            ...
            <div className="grid grid-cols-7 mb-2">
                {DAYS.map(day => (
                    <div key={day} className="text-center text-[11px] text-gray-400 font-bold uppercase tracking-wider py-1">
                        {day}
                    </div>
                ))}
            </div>
                                    ...
                                    isSelected || isRangeStart || isRangeEnd
                                        ...
                                        : inRange
                                            ...
                                            : isDisabled
                                                ...
                                                : isToday
                                                    ? "bg-gray-100 text-blue-600 font-bold border border-blue-200"
        ...
        <div className="w-full">
            <button
                ...
                className={cn(
                    ...
                    isOpen
                        ? "border-primary shadow-[0_0_0_1px_rgba(59,130,246,0.1)] bg-white"
                        : error
                            ? "border-red-300 bg-red-50/30 hover:border-red-400 text-red-900"
            ...
            >
                ...
                <div className={cn(
                    ...
                    <span className={cn(
                        ...
                        hasValue ? (error ? "text-red-900" : "text-gray-900") : "text-gray-400"
                    )}>
                        {value || placeholder}
                    </span>
                </div>
