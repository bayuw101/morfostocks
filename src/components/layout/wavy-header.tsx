...
export function WavyBackground({ children, title, subtitle }: { children?: React.ReactNode, title?: string, subtitle?: string }) {
    return (
        <div className="relative bg-gradient-to-r from-blue-600 to-indigo-600 pt-12 pb-10 md:pt-24 md:pb-40 overflow-hidden -mt-10 shrink-0">
            {/* SVG Waves — uses CSS dark: toggle instead of JS to avoid any flash */}
            <div className="hidden md:block absolute bottom-[-1px] left-0 right-0 overflow-hidden leading-none z-0">
